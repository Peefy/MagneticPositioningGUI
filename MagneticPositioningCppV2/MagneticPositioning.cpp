// MagneticPositioning.cpp : �������̨Ӧ�ó������ڵ㡣
//
...
double F4_matrix[3][3] = { { 0.105294561427287,0.292078314347514,-0.073687277495538 },{0.281440721479004,0.074010572495803,-0.069331405357788},{0.073149986764519, 0.069709672092147, 0.179587499495770} };
...
int counter=0;
int flag = 0;
double flag2, x_pre, y_pre, z_pre;
